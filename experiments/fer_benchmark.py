...
test_datas = ImageFolder(root=ROOT / "data" / "FER-2013" / "test", transform=get_transform())
...
export_confusion_matrix(y_true, y_pred, class_names=test_datas.classes, dataset="fer")
export_classification_report(y_true, y_pred, class_names=test_datas.classes, dataset="fer")